...
export const archiveDetailsMap = {
  ...
  '121': {
    ...
    subtitle: '구조 위에 놓인 순간',
    description: '도시 내부의 계단 구조 위에서 인물과 의복은 하나의 흐름을 형성합니다. 패션은 단순한 착용을 넘어, 공간과 긴장 속에서 장면을 구성하는 요소로 작용합니다.',
    images: {
      hero: fashion01,
      related: fashion01,
    },
    ...
    sections: [{
        heading: '01. 흐르는 자세',
        body: [
          '기울어진 몸의 각도와 늘어진 팔의 선은 공간과 맞물리며 하나의 흐름을 만듭니다.',
          '이 자세는 단순한 포즈가 아니라, 구조 위에서 만들어지는 균형의 결과입니다.',
        ],
      },
      {
        heading: '02. 구조와 맞닿는 실루엣',
        body: [
          '계단의 직선과 난간의 곡선 사이에서 의복의 실루엣은 대비를 이루며 드러납니다.',
          '부드러운 소재는 단단한 구조와 충돌하며 시각적인 긴장을 만듭니다.',
        ],
      },
      {
        heading: '03. 장면으로서의 긴장',
        body: [
          '이 장면에서 인물은 공간 위에 놓인 하나의 요소로 존재합니다.',
          '패션은 몸을 감싸는 것을 넘어, 구조와 함께 긴장을 형성하는 장면이 됩니다.',
        ],
      },
    ],
    quote: '패션은 몸이 아니라, 구조 위에 놓인 순간이다.',
    notes: [{
        label: 'Form',
        title: '기울어진 선',
        text: '자세에서 드러나는 비대칭의 흐름.',
      },
      {
        label: 'Material',
        title: '대비된 질감',
        text: '부드러운 원단과 거친 구조의 대비.',
      },
      {
        label: 'Structure',
        title: '계단 구조',
        text: '공간의 방향성을 만드는 요소.',
      },
      {
        label: 'Tension',
        title: '정지된 긴장',
        text: '멈춘 순간 속에서 유지되는 균형.',
      },
    ],
    relatedIds: ['123', '122', '120'],
  },
