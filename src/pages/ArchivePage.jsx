                        ...
                        <div className="divide-y divide-outline-variant/10">
                          {group.map((item) => (
                            ...
                            >
                              ...
                              <div className="mt-3 text-base uppercase tracking-[0.22em] text-on-surface-variant md:col-span-2 md:mt-0 md:block">{item.category}</div>
                              ...
                              <div className="mt-3 text-base uppercase tracking-[0.22em] text-outline md:col-span-2 md:mt-0 md:text-right">{item.year}</div>
                            </Link>
                          ))}
                        </div>
                      </div>
