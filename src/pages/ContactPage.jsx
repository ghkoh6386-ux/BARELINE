    ...
    <div className="space-y-16 px-6 py-12 md:px-8 md:py-16">
      <header className="grid gap-10 lg:grid-cols-12 lg:items-end">
        <div className="lg:col-span-7">
          <p className="text-[10px] uppercase tracking-[0.3em] text-outline">{contactPageContent.hero.eyebrow}</p>
        ...
        <div className="space-y-12 lg:col-span-4 lg:col-start-9">
          <div>
            <p className="mb-4 text-[11px] uppercase tracking-[0.28em] text-outline">{contactPageContent.contact.label}</p>
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <p className="mb-4 text-[11px] uppercase tracking-[0.28em] text-outline">{contactPageContent.address.label}</p>
            ...
            <div>
              <p className="mb-4 text-[11px] uppercase tracking-[0.28em] text-outline">{contactPageContent.channels.label}</p>
          ...
          <div className="space-y-10">
            <form className="space-y-10">
              <label className="block space-y-3">
                <span className="text-[10px] uppercase tracking-[0.28em] text-outline">{contactPageContent.formSection.fields.name.label}</span>
              ...
              <label className="block space-y-3">
                <span className="text-[10px] uppercase tracking-[0.28em] text-outline">{contactPageContent.formSection.fields.inquiry.label}</span>
              ...
              <label className="block space-y-3">
                <span className="text-[10px] uppercase tracking-[0.28em] text-outline">{contactPageContent.formSection.fields.message.label}</span>
